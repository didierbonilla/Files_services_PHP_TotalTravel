...
// SAVE REPORT DATA 
$hotelsList = json_decode($_API->HTTPRequest("/API/Rstaurant/List", "GET", null),true); // CAMBIO #1
...
$pdf->report_tittle = "REPORTE DE RESTAURANTES";
...
if(count($dataFilter) > 0){
    ...
    $pdf->tablewidths = array(8,50,50,80); // TAMAÑOS EN MM DE CADA COLUMNA  // CAMBIO #3
